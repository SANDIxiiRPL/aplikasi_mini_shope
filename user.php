    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="user.php">
                ...
                <div class="sidebar-brand-text mx-3">mini shope<sup></sup></div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="?url=tulis_catatan">
                    ...
                    <span>Tulis Catatan Belanja</span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="?url=catatan_kegiatan">
                    ...
                    <span>Lihat Catatan Belanja</span></a>
            </li>
                    ...
                    <div class="h5 mb-4 text-gray-800">
                        <?php 
                            if(!empty(@$_GET['url'])){
                                ...
                                echo "welcome to mini shope coffe. ";
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; mini shope 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
